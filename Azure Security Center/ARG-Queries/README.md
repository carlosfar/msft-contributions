...
This starter kit consists of a set of basic ARG queries that have been created to help anyone build on top and customize them based on needs and requirements.
